define([
        ...
        "dojo/text!./templates/customerInfoWindow.html"
],
    function (Evented,
              on,
              query,
        ...
        return declare([InfoWindowBase, Evented, _TemplatedMixin], {
            ...
            _showInfoWindow: function (extent) {
                ...
                domStyle.set(this.domNode, {
                    "left": (showScreenPoint.x - _domNodeWidth / 2) + "px",
                    "top": (showScreenPoint.y - 80) + "px"
                });
            ...
            move: function (location) {
                ...
                if (showMapPoint.spatialReference) {
                    ...
                    domStyle.set(this.domNode, {
                        "left": (screenPoint.x - _domNodeWidth / 2) + "px",
                        "top": (screenPoint.y - 80) + "px"
                    });
                }
            },
