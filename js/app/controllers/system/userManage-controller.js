define(['bootstrap/app', 'utils', 'services/system-service'], function (app, utils) {
    ...
    app.controller('userManage-controller', ['$rootScope', '$scope', '$state', 'toaster', '$uibModal', '$uibModalInstance', 'values', 'system-service',
        function ($rootScope, $scope, $state, toaster, $uibModal, $modalInstance, values, systemService) {
